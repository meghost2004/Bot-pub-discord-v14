...
.addFields({ name: '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━', value: `> **__Liste des variables__** :`, inline: false })
.addFields({ name: '{member.tag}', value: `> Afficher la personne avec sont nom et sont tag.`, inline: false })
.addFields({ name: '{member.id}', value: `> Afficher l'identifiant de la personne.`, inline: false })
.addFields({ name: '{guild.name}', value: `> Afficher le nom du serveur.`, inline: false })
.addFields({ name: '{guild.id}', value: `> Afficher l'identifiant du serveur.`, inline: false })
